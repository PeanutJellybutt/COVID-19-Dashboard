...
var App = /*#__PURE__*/function (_React$Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(App, [{
    ...
    key: "globalRankingText",
    value: function globalRankingText(category) {
      //console.log(category);
      if (category == 'Confirmed') return "confirmed cases count";else if (category == 'Hospitalized') return "active cases count";else if (category == 'Deaths') return "deceased cases count";else if (category == 'Recovered') return "recovered cases count";else if (category == 'RecoveryRate') return "recovery rate";else if (category == 'MortalityRate') return "deceased rate";
    }
  }, {
    key: "render",
    value: function render() {
      ...
      __jsx(react__WEBPACK_IMPORTED_MODULE_6___default.a.Fragment, null, __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_14__["default"], {
      ...
      }, "Global ranking based on: ", this.globalRankingText(this.state.selectCategory))))), __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_14__["default"], {
        item: true,
        xs: 2,
        __self: this,
        __source: {
        ...
        value: 'Hospitalized',
        onClick: function onClick(select) {
          _this2.setState({
...
//# sourceMappingURL=index.js.db2118a3f3f65f4ca2c4.hot-update.js.map