...
import {fetchData, callAPIGlobalAll, callAPIGlobalTimeline,
	...
	getLastDate, getDateDiff, processData} from '../utils/dataFetch.js';
	
//RANKING
import {countryCompare, globalRankSelect, globalRankTopTen,
	globalRanking, globalRankingHeading} from '../utils/dataRank.js';
	
//JVECTORMAP
import {countryEncodeAssist, countryDecodeAssist, processMapGlobalData} from '../utils/dataMap.js';
